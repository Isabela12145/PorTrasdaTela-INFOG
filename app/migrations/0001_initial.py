# Generated by Django 5.2.5 on 2025-11-30 23:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialidade', models.CharField(blank=True, max_length=200, verbose_name='Especialidade / Área')),
                ('descricao', models.TextField(blank=True, verbose_name='Descrição')),
                ('foto_url', models.URLField(blank=True, help_text='Coloque uma URL pública (http(s)) apontando para a imagem do profissional', max_length=500, verbose_name='URL da Foto')),
            ],
        ),
        migrations.CreateModel(
            name='Recompensa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(verbose_name='Descrição')),
                ('profissionalAutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conteudos', to='app.profissional', verbose_name='Autor (Profissional)')),
            ],
        ),
        migrations.CreateModel(
            name='usuarios',
